...
public class TestDataLoader {
    ...
    public CommandLineRunner initUsers(UserRepository userRepository, MovieRepository movieRepository) {
        return (args) -> {
            ...
            User u1 = new User("UserA", "Peter Klein", encodedPassword, "peter.klein@example.com","", "USER", false, Set.of(m1,m2,m3));
            User u2 = new User("UserB", "Susan McDonald", encodedPassword, "susan.mcdonald@example.com", "","USER", true, Set.of(m4,m5,m6));
            User u3 = new User("UserC", "Jane Smith", encodedPassword, "jane.smith@example.com", "","ADMIN", true, Set.of(m7,m1,m5));
            User u4 = new User("UserD", "Mark Taylor", encodedPassword, "mark.taylor@example.com", "","USER", false, Set.of(m5,m4,m7));
